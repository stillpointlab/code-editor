...
const KEYMAP_MODES: readonly EditorKeymapMode[] = ['normal', 'vim'];
 ...
 * `keymap-mode` selects normal or Vim keyboard behavior and returns explicit
 * unsupported results for invalid modes.
 */
